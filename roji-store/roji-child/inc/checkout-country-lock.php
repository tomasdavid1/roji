...
/**
 * Cart shipping calculator: hide the country select entirely and
 * print the same locked line. The shipping calculator markup is
 * generated by woocommerce/cart/shipping-calculator.php; we patch
 * the rendered output via a JS-free CSS class that hides the
 * country row, plus a notice we inject above it.
 */
add_action(
	'woocommerce_before_shipping_calculator',
	function () {
		echo '<p class="roji-country-lock-line roji-country-lock-line--cart">'
			. '<span class="roji-country-lock-line__label">Ships to</span>'
			. '<span class="roji-country-lock-line__value">United States only</span>'
			. '</p>';
	}
);
